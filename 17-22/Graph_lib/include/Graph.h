...
struct Line_style {
	...
	Line_style(Line_style_type lst, int ww = 0) 
		:s(int(lst)), w(ww) { }		
...
struct Function : Shape {
	...
	Function( std::function<double(double)> f, double r1, double r2, Point xy, int count, double xscale, double yscale);
